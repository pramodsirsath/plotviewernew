...
const OVERLAY_FILL_LIFT = 0.014;
const OVERLAY_OUTLINE_LIFT = 0.012;
const OVERLAY_TEXT_LIFT = 0.017;
const OVERLAY_DIMENSION_LIFT = 0.014;
const OUTLINE_PADDING = 1;
const DIMENSION_LABEL_OFFSET = OUTLINE_PADDING + 2.5;
const FEET_TO_METERS = 0.3048;

const OVERLAY_FILL_RENDER_ORDER = 22;
const OVERLAY_OUTLINE_RENDER_ORDER = 24;
const OVERLAY_TEXT_RENDER_ORDER = 26;
  ...
  return (
    <group>
      <DreiLine
        ...
        depthWrite={false}
        depthTest={false}
        renderOrder={OVERLAY_OUTLINE_RENDER_ORDER}
      />
      ...
      <mesh
        ...
        rotation={[-Math.PI / 2, 0, 0]}
        renderOrder={OVERLAY_FILL_RENDER_ORDER}
      >
        <meshBasicMaterial
      ...
      <GroundTextLabel3D
        ...
        outlineWidth={0.15}
        depthWrite={false}
        renderOrder={OVERLAY_TEXT_RENDER_ORDER}
        depthTest={false}
      />
