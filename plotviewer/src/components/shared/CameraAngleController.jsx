...
//     // 🔥 KEY FIX: different angle for mobile
//     const toPhi = isTopDown
//       ? targetPhi2D
//       : isMobile
//       ? Math.PI / 3.2   // 🔥 more upright for mobile
//       : targetPhi3D;

//     let fromTheta =
//       typeof activeControls.getAzimuthalAngle === 'function'
//         ? activeControls.getAzimuthalAngle()
//         : sph.theta;

//     // Save control state
//     anim.current.origEnabled =
//       typeof activeControls.enabled !== 'undefined'
//         ? activeControls.enabled
//         : true;
...
//     const isMobile = size.width < 768;
//     const totalDuration = isMobile ? 250 : duration;

//     const t = Math.min(elapsed / totalDuration, 1);

//     const ease = 1 - Math.pow(1 - t, 4);

//     const target = anim.current.target;

//     const offset = camera.position.clone().sub(target);
//     const sph = new THREE.Spherical().setFromVector3(offset);

//     const newPhi = THREE.MathUtils.lerp(
//       anim.current.fromPhi,
//       anim.current.toPhi,
//       ease
//     );
...
//     sph.phi = Math.max(0.0001, Math.min(Math.PI - 0.0001, newPhi));
...
//       if (isTopDown) {
//         activeControls.minPolarAngle = TOP_DOWN_PHI_EPS;
//         activeControls.maxPolarAngle = TOP_DOWN_PHI_EPS;
//       } else {
//         const finalPhi = size.width < 768
//           ? Math.PI / 3.2
//           : targetPhi3D;

//         activeControls.minPolarAngle = finalPhi;
//         activeControls.maxPolarAngle = finalPhi;
//       }

//       activeControls.enabled = anim.current.origEnabled;
