export function createCustomOverlayClass(googleMaps) {
  class CustomMapOverlay extends googleMaps.OverlayView {
    constructor(bounds, imageSrc, opacity, rotation, scale, onDragEnd) {
      super();
      this.bounds_ = bounds;
    ...
    onAdd() {
      ...
      this.div_.style.cursor = "move"; // Indicate draggable
      // Enable pointer events to intercept clicks and drags
